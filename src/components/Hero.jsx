    ...
    return (
        <section className="relative min-h-[calc(100vh+2rem)] flex items-center justify-center overflow-hidden bg-neutral-950">
            ...
            >
                ...
                >
                    As the leading <span className="text-indigo-300 font-medium tracking-wide">Event Management Company in Shivamogga</span>, we transform your vision into extraordinary experiences. From premium <span className="text-indigo-300 font-medium">wedding planning in Shimoga</span> to grand corporate celebrations, we ensure every detail is perfect.
                </motion.p>
